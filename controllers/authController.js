...
const googleLogin = (req, res) => {
    const googleAuthUrl =`https://accounts.google.com/o/oauth2/auth?client_id=${process.env.GOOGLE_CLIENT_ID}&redirect_uri=https://memora-backend-tau.vercel.app/auth/google/callback&response_type=code&scope=profile email`
        ...
        const tokenResponse = await axios.post("https://oauth2.googleapis.com/token",
            {
                ...
                redirect_uri: `https://memora-backend-tau.vercel.app/auth/google/callback`,
            },
            {
